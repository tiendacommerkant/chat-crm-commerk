      ...
      <aside className="w-64 bg-commerk-navy text-white flex flex-col shrink-0">
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-commerk-green/20 border border-commerk-green/30 flex items-center justify-center">
              <svg className="w-5 h-5 text-commerk-green" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h2 className="text-base font-bold text-white leading-tight">Commerk</h2>
              <p className="text-xs text-slate-400">CRM & Chatbot</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          ...
          <p className="text-xs text-slate-600 mt-2 px-3">tiendacommerkant.com.co</p>
        </div>
      </aside>
